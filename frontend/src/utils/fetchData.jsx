...
export const  url = 'https://gym-verse-final-backend.vercel.app'
...
export const applyDoctor = async (userId, data) => {
  try {
    const response = await axios.post(`${url}/create-profile/${userId}`, data)
    return response.data
  } catch (error) {
    console.log(error)
  }
...
export const getAllRequests = async () => {
  try {
    const response = await axios.get(`${url}/getallrequests`)
    return response.data
  } catch (error) {
 console.log(error)   
 return error
