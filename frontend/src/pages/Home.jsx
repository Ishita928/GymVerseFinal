        ...
        (
          <div className="App overflow-hidden ">
            ...
            <section className=" bg-gradient-to-br from-gray-700 via-gray-900 to-gray-950">
              ...
              <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 bg-[#f7f2ee]" id='fitnessTracker'>
                ...
                <div className="mr-auto place-self-center lg:col-span-7 ml-6">
                  <h1 className="max-w-2xl text-[#c49782]  text-xl font-extrabold text-left  md:text-5xl xl:text-5xl mb-8 ">Elevate Your Fitness Experience with Advanced Tracking</h1>
                  <p className="max-w-2xl mb-6   lg:mb-8 text-left md:text-m font-bold lg:text-l italic  special-heading text-slate-600 ">"Unlock Your Potential and Achieve Optimal Fitness Levels Through Cutting-Edge Data-Driven Tracking"


                  </p>
                  <button onClick={handleBooking} className="inline-flex items-center mb-4 lg:mb-0 justify-center px-5 py-3 mr-3 text-base font-medium text-center text-[#7a4831]  border border-white  rounded-lg bg-primary-700 hover:bg-primary-800 " >
                    Fitness Tracker
                    <svg className="w-5 h-5 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                  </button>
                  <Link to="/Bmi" className=" text-[#7a4831] inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center  border  rounded-lg  focus:ring-4  border-gray-700 hover:bg-[#986d59] focus:ring-gray-800">
                    BMI Calculator
                  </Link>
                </div>
            ...
            <div>
              <footer className="  py-6">
                <div className="container mx-auto text-center">
                  <p className="mb-4 text-black">© 2024 GymVerse. All rights reserved.</p>
