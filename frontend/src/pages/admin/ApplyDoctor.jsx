...
import { applyDoctor } from '../../utils/fetchData';
...
const ApplyDoctor = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await applyDoctor(user?.id, data).then(() => {
      toast({
              ...
              <Stack spacing={4}>
                ...
                <FormControl isRequired>
                  ...
                  <Select
                    ...
                    onChange={handleInputChange}
                  >
                    <option className="text-black" value="Sports Nutrition">
                    Sports Nutrition
                    </option>
                    <option className="text-black" value="Weight Management">
                    Weight Management
                    </option>
                    <option className="text-black" value="Public Health Nutrition">
                    ...
                    <option className="text-black" value="Pediatric Nutrition">
                    Pediatric Nutrition
                    </option>
                    <option className="text-black" value="Clinical Dietetics">
                    Clinical Dietetics
                    </option>
                  </Select>
                </FormControl>
