...
function Aibot() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen  bg-[#f7f2ee]">
      ...
      <main>
        <button 
          className="flex items-center px-4 py-2 bg-[#c49782] text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75"
