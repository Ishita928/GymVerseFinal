...
const Navbar = () => {
  ...
  return (
    <Flex justifyContent="space-between" alignItems="center" p="2" color="#c49782" backgroundColor='#261b13'>
      {/* Logo */}
      <Link to={'/'}>
        <img src={logo} width='140px'  className=" ml-1 mt-1" alt="Virtual GymVerse" />
      </Link>
